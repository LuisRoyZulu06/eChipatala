defmodule Echipatala.Pages do
  ...
  def search_options(params) do
    ...
    draw = try do String.to_integer(params["draw"]) rescue _-> params["draw"] end
    ...
    Enum.reduce(params, %{}, fn {k, value}, acc ->
      val =
        cond do
          ...
          true ->
            binary_to_string = (fn str -> if is_binary(str), do: Enum.join(for <<c::utf8 <- str>>, do: <<c::utf8>>), else: str end)
