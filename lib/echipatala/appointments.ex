defmodule Echipatala.Appointments do
  @moduledoc """
  ...
  @doc """
  Returns the list of tbl_appointment.

  ## Examples

      iex> list_tbl_appointment()
      [%Appointment{}, ...]

  """
  def list_tbl_appointment do
    Repo.all(Appointment)
  end

  #=========== client institution appointments ==================
  def client_appointments(inst_id, client_id) do
    Appointment
