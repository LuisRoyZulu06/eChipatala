$(document).ready(function() {
    ...
    var tbl_disease_symptom_table= $('#tbl_disease_symptom_mngt').DataTable({
        "select": {
            "style": 'multi'
        },
        "responsive": true,
        ...
        'language': {
            ...
            "emptyTable": "No Disease Symptom Details to display"
        },
        "paging": true,
        "serverSide": true,
        "ajax": {
            "type"   : "POST",
            "url"    : '/Disease/Symptom/Management/table',
            "data"   : {
    ...
    $('#btn_disease_symptom_filter').on( 'click', function () {
        tbl_disease_symptom_table.on('preXhr.dt', function ( e, settings, data ) {
            console.log(data)
        ...
        $('#disease_symptomfilter').modal('hide');
        tbl_disease_symptom_table.draw();
    });

    $('#reload_table').on( 'click', function () {
        tbl_disease_symptom_table.ajax.reload();
    });
    ...
    $('#tbl_disease_symptom_tables tbody').on('click', '.view_details', function () {
        $.blockUI();
		$.ajax({
            url: "/User/details",
            type: 'POST',
        ...
        //--------------------------approve------------------------------------
        $('#tbl_disease_symptom_tables tbody').on('click', '.approve', function () {
            Swal.fire({
    ...
    //-------------------------- Reset Password-------------------------------
    $('#tbl_disease_symptom_tables tbody').on('click', '.reset_password', function () {
        var btn = $(this);
    ...
    //---------------------------- Edit --------------------------------
    $('#tbl_disease_symptom_tables tbody').on('click', '.update_details', function () {
        $.blockUI();
		$.ajax({
            url: "/User/details",
            type: 'POST',
    ...
    //--------------------------Deactivate-------------------------
    $('#tbl_disease_symptom_tables tbody').on('click', '.deactivate', function () {
        Swal.fire({
    ...
    //--------------------------Activate-----------------------------------
    $('#tbl_disease_symptom_tables tbody').on('click', '.activate', function () {
        Swal.fire({
    ...
    //--------------------------Unblock-----------------------------------
    $('#tbl_disease_symptom_tables tbody').on('click', '.unblock', function () {
        Swal.fire({
    ...
    //--------------------------Delete--------------------------------------
    $('#tbl_disease_symptom_tables tbody').on('click', '.delete', function () {
        var btn = $(this);
        Swal.fire({
